...
A ready-made cast is already in the repo: **`trustgate.cast`** (asciicast v2, generated by
`python scripts/make_cast.py` from real command output). Regenerate it any time.
